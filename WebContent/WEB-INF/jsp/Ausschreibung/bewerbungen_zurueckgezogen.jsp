...
<s:set var="activeFilter" value="'zurueckgezogen'" />
...
<s:if test="#emptyList">
	<div class="alert alert-info centerTxt">
		<s:if test="#session.angemeldeterBenutzer.gruppeId == 2"><s:text name="Ausschreibung.listen.bewerbungen.zurueckgezogen.bewerber" /></s:if>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 3"><s:text name="Ausschreibung.listen.bewerbungen.zurueckgezogen.ausschreiber" /></s:elseif>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 4"><s:text name="Ausschreibung.listen.bewerbungen.zurueckgezogen.bearbeiter" /></s:elseif>
	</div>
</s:if>
<s:else>
