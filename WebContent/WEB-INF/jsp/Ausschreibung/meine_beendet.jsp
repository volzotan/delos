...
<s:set var="activeFilter" value="'beendet'" />
		...
		<tbody>
			<s:iterator value="listeDaten" status="status">
				...
				<tr class="hyperlink" data-toggle="<s:url action="Ausschreibung_anzeigen"><s:param name="ausschreibungId" value="id" /></s:url>">
					<td><a href="javascript:void()"><s:property value="%{name.length() > 80 ? name.substring(0, 80) + getText('global.text.ellipse') : name}" /></a></td>
