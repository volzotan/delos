...
<s:set var="activeFilter" value="'abgeschlossen'" />
...
<s:if test="#emptyList">
	<div class="alert alert-info centerTxt">
		<s:if test="#session.angemeldeterBenutzer.gruppeId == 2"><s:text name="Ausschreibung.listen.bewerbungen.abgeschlossen.bewerber" /></s:if>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 3"><s:text name="Ausschreibung.listen.bewerbungen.abgeschlossen.ausschreiber" /></s:elseif>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 4"><s:text name="Ausschreibung.listen.bewerbungen.abgeschlossen.bearbeiter" /></s:elseif>
	</div>
</s:if>
<s:else>
	<s:if test="#session.angemeldeterBenutzer.gruppeId == 2">
		...
		<jsp:include page="../Template/paginatorBottom.jsp" flush="false" />s
	</s:if>
