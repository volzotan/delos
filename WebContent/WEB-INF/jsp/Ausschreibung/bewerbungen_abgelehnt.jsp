...
<s:set var="activeFilter" value="'abgelehnt'" />
...
<s:if test="#emptyList">
	<div class="alert alert-info centerTxt">
		<s:if test="#session.angemeldeterBenutzer.gruppeId == 2"><s:text name="Ausschreibung.listen.bewerbungen.abgelehnt.bewerber" /></s:if>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 3"><s:text name="Ausschreibung.listen.bewerbungen.abgelehnt.ausschreiber" /></s:elseif>
		<s:elseif test="#session.angemeldeterBenutzer.gruppeId == 4"><s:text name="Ausschreibung.listen.bewerbungen.abgelehnt.bearbeiter" /></s:elseif>
	</div>
</s:if>
<s:else>
