		...
		<div class="row">
			...
			<s:if test="#session.angemeldeterBenutzer.gruppeId == 4 || #session.angemeldeterBenutzer.gruppeId == 1">				
				...
				<div class="well">
					...
					von bereits vorhandenen Dokumenten, alle auswählen die der Bewerber zusätzlich abgeben soll. Sollten die nötigen Dokumente noch nicht
					aufgeführt sein können Sie ein neues Dokument hinzufügen. Die Seite auf der Sie Dokumente anfordern können erreichen Sie über die
					Detailansicht des jeweiligen Bewerbungsvorgangs.
				</div>
				<h3 id="12">Wie bestätige ich bereits eingegangen Dokumente?</h3>
				<div class="well">
					Die Bestätigung der Dokumente kann entweder in der Dokumentenauswahl oder in der Detailansicht eines Bewerbungsvorgangs
					vorgenommen werden.
				</div>
